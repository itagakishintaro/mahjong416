...
t([e({type: Boolean, reflect: !0})], f.prototype, 'inset', void 0),
  t(
 ...
 */
var z;
const C = Symbol('indicator'),
  j = Symbol('animateIndicator'),
  I = (function (a) {
    var r, o, i;
    class s extends a {
      constructor() {
        super(...arguments), (this[r] = !0), (this[o] = null), (this[i] = !1);
      }
      get [_]() {
        return this[w];
      }
    ...
    return t([e({noAccessor: !0})], s.prototype, 'tabIndex', void 0), s;
  })(a);
class S extends I {
  get selected() {
    return this.active;
  ...
  render() {
    const t = c`<div class="indicator"></div>`;
    return c`<div
      class="button"
      role="presentation"
...
t(
  [e({type: Boolean, reflect: !0, attribute: 'md-tab'})],
  S.prototype,
  'isTab',
  void 0
),
  t([e({type: Boolean, reflect: !0})], S.prototype, 'active', void 0),
  t([e({type: Boolean})], S.prototype, 'selected', null),
  t(
  ...
  t([s('.indicator')], S.prototype, z, void 0),
  t([i()], S.prototype, 'fullWidthIndicator', void 0),
  t([n({flatten: !0})], S.prototype, 'assignedDefaultNodes', void 0),
  t([l({slot: 'icon', flatten: !0})], S.prototype, 'assignedIcons', void 0);
/**
 * @license
 * Copyright 2023 Google LLC
 * SPDX-License-Identifier: Apache-2.0
...
t([l({flatten: !0, selector: '[md-tab]'})], E.prototype, 'tabs', void 0),
  t(
    [e({type: Number, attribute: 'active-tab-index'})],
    E.prototype,
    'activeTabIndex',
    null
  ),
  t(
    [e({type: Boolean, attribute: 'auto-activate'})],
    E.prototype,
    'autoActivate',
    void 0
  ),
  t([s('.tabs')], E.prototype, 'tabsScrollerElement', void 0),
  t([s('slot')], E.prototype, 'slotElement', void 0);
const B = r`:host{box-sizing:border-box;display:flex;flex-direction:column;overflow:auto;scroll-behavior:smooth;scrollbar-width:none;position:relative}:host([hidden]){display:none}:host::-webkit-scrollbar{display:none}.tabs{align-items:end;display:flex;height:100%;overflow:inherit;scroll-behavior:inherit;scrollbar-width:inherit;justify-content:space-between;width:100%}::slotted(*){flex:1}::slotted([active]){z-index:1}
`;
/**
 * @license
 * Copyright 2023 Google LLC
...
t(
  [e({type: Boolean, attribute: 'inline-icon'})],
  R.prototype,
  'inlineIcon',
  void 0
);
...
(K.styles = [A, F]), (K = t([o('md-primary-tab')], K));
/**
 * @license
...
class M extends a {
  ...
  renderListItem(t) {
    ...
    const r = e && this.target ? this.target : h;
    return y`
      <${a}
        id="item"
...
p(M),
  (M.shadowRootOptions = {...a.shadowRootOptions, delegatesFocus: !0}),
  t([e({type: Boolean, reflect: !0})], M.prototype, 'disabled', void 0),
  t([e()], M.prototype, 'type', void 0),
  t([e()], M.prototype, 'href', void 0),
  t([e()], M.prototype, 'target', void 0),
  t(
  ...
  t([e({type: Boolean})], M.prototype, 'selected', void 0),
  t([s('.list-item')], M.prototype, 'listItemRoot', void 0),
  t([l({slot: 'headline'})], M.prototype, 'headlineElements', void 0),
  t(
  ...
  t([n({slot: ''})], M.prototype, 'defaultElements', void 0),
  t([e({attribute: 'typeahead-text'})], M.prototype, 'typeaheadText', null);
/**
 * @license
 * Copyright 2022 Google LLC
 * SPDX-License-Identifier: Apache-2.0
...
(O.styles = [u]), (O = t([o('md-menu-item')], O));

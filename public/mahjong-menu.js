import{b as t,A as e,i as a,a as r,t as o}from"./custom-element-BXQNS_jb.js";import{_ as i,n as s,r as c}from"./firestore-D_LKr_7c.js";import"./mahjong-today.js";import{e as n,n as l,o as d,a as h,E as v}from"./select-option-B1crfLlK.js";import"./mahjong-calc.js";import"./mahjong-stats.js";import"./mahjong-individual.js";import"./mahjong-title.js";import"./mahjong-rule.js";import"./utils-D4GKOtwe.js";import"./calc-sub-styles-CIbie5BY.js";import"./pf-accordion-DQA9naLD.js";
/**
 * @license
...
let $=class extends k{};$.styles=[I,C],$=i([o("md-primary-tab")],$);var S=function(t,e,a,r){for(var o,i=arguments.length,s=i<3?e:null===r?r=Object.getOwnPropertyDescriptor(e,a):r,c=t.length-1;c>=0;c--)(o=t[c])&&(s=(i<3?o(s):i>3?o(e,a,s):o(e,a))||s);return i>3&&s&&Object.defineProperty(e,a,s),s};let B=class extends a{render(){return t`
    ...
    `}constructor(){super(),this._activeTab=0,this._prefillData=null,this.addEventListener("uploaded",this._uploaded),this.addEventListener("edit-game",this._editGame),this.addEventListener("edit-cancelled",this._uploaded)}_changed(t){const e=t.target.activeTabIndex;0!==e&&(this._prefillData=null),this._activeTab=e}_uploaded(){this.shadowRoot.querySelector("#today").click()}_editGame(t){const e=t.detail;this._prefillData=e;this.shadowRoot.querySelector("#calc").click()}};S([c()],B.prototype,"_activeTab",void 0),S([c()],B.prototype,"_prefillData",void 0),B=S([o("mahjong-menu")],B);export{B as MahjongMenu};

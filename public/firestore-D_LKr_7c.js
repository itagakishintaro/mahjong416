 ...
 * limitations under the License.
 */
const ci=/^__.*__$/;class hi{constructor(t,e,n){this.data=t,this.fieldMask=e,this.fieldTransforms=n}toMutation(t,e){return null!==this.fieldMask?new gr(t,this.data,this.fieldMask,e,this.fieldTransforms):new mr(t,this.data,e,this.fieldTransforms)}}function li(t){switch(t){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw he(40011,{dataSource:t})}}class fi{constructor(t,e,n,r,i,s){this.settings=t,this.databaseId=e,this.serializer=n,this.ignoreUndefinedProperties=r,void 0===i&&this.validatePath(),this.fieldTransforms=i||[],this.fieldMask=s||[]}get path(){return this.settings.path}get dataSource(){return this.settings.dataSource}contextWith(t){return new fi({...this.settings,...t},this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}childContextForField(t){const e=this.path?.child(t),n=this.contextWith({path:e,arrayElement:!1});return n.validatePathSegment(t),n}childContextForFieldPath(t){const e=this.path?.child(t),n=this.contextWith({path:e,arrayElement:!1});return n.validatePath(),n}childContextForArray(t){return this.contextWith({path:void 0,arrayElement:!0})}createError(t){return Ni(t,this.settings.methodName,this.settings.hasConverter||!1,this.path,this.settings.targetDoc)}contains(t){return void 0!==this.fieldMask.find((e=>t.isPrefixOf(e)))||void 0!==this.fieldTransforms.find((e=>t.isPrefixOf(e.field)))}validatePath(){if(this.path)for(let t=0;t<this.path.length;t++)this.validatePathSegment(this.path.get(t))}validatePathSegment(t){if(0===t.length)throw this.createError("Document fields must not be empty");if(li(this.dataSource)&&ci.test(t))throw this.createError('Document fields cannot begin and end with "__"')}}class di{constructor(t,e,n){this.databaseId=t,this.ignoreUndefinedProperties=e,this.serializer=n||jr(t)}createContext(t,e,n,r=!1){return new fi({dataSource:t,methodName:e,targetDoc:n,path:Ve.emptyPath(),arrayElement:!1,hasConverter:r},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function pi(t){const e=t._freezeSettings(),n=jr(t._databaseId);return new di(t._databaseId,!!e.ignoreUndefinedProperties,n)}function wi(t,e,n,r,i,s={}){const o=t.createContext(s.merge||s.mergeFields?2:0,e,n,i);yi("Data must be an object, but it was:",o,r);const u=gi(r,o);let a,c;if(s.merge)a=new er(o.fieldMask),c=o.fieldTransforms;else if(s.mergeFields){const t=[];for(const r of s.mergeFields){const i=vi(e,r,n);if(!o.contains(i))throw new we(pe.INVALID_ARGUMENT,`Field '${i}' is specified in your field mask but missing from your input data.`);Ii(t,i)||t.push(i)}a=new er(t),c=o.fieldTransforms.filter((t=>a.covers(t.field)))}else a=null,c=o.fieldTransforms;return new hi(new nr(u),a,c)}function mi(t,e){if(bi(t=_(t)))return yi("Unsupported field value:",e,t),gi(t,e);if(t instanceof oi)return function(t,e){if(!li(e.dataSource))throw e.createError(`${t._methodName}() can only be used with update() and set()`);if(!e.path)throw e.createError(`${t._methodName}() is not currently supported inside arrays`);const n=t._toFieldTransform(e);n&&e.fieldTransforms.push(n)}(t,e),null;if(void 0===t&&e.ignoreUndefinedProperties)return null;if(e.path&&e.fieldMask.push(e.path),t instanceof Array){if(e.settings.arrayElement&&4!==e.dataSource)throw e.createError("Nested arrays are not supported");return function(t,e){const n=[];let r=0;for(const i of t){let t=mi(i,e.childContextForArray(r));null==t&&(t={nullValue:"NULL_VALUE"}),n.push(t),r++}return{arrayValue:{values:n}}}(t,e)}return function(t,e){if(null===(t=_(t)))return{nullValue:"NULL_VALUE"};if("number"==typeof t)return function(t,e){return function(t){return"number"==typeof t&&Number.isInteger(t)&&!We(t)&&t<=Number.MAX_SAFE_INTEGER&&t>=Number.MIN_SAFE_INTEGER}(e)?function(t){return{integerValue:""+t}}(e):ar(t,e)}(e.serializer,t);if("boolean"==typeof t)return{booleanValue:t};if("string"==typeof t)return{stringValue:t};if(t instanceof Date){const n=mn.fromDate(t);return{timestampValue:Sr(e.serializer,n)}}if(t instanceof mn){const n=new mn(t.seconds,1e3*Math.floor(t.nanoseconds/1e3));return{timestampValue:Sr(e.serializer,n)}}if(t instanceof ui)return{geoPointValue:{latitude:t.latitude,longitude:t.longitude}};if(t instanceof ii)return{bytesValue:Dr(e.serializer,t._byteString)};if(t instanceof ti){const n=e.databaseId,r=t.firestore._databaseId;if(!r.isEqual(n))throw e.createError(`Document reference is for database ${r.projectId}/${r.database} but should be for database ${n.projectId}/${n.database}`);return{referenceValue:_r(t.firestore._databaseId||e.databaseId,t._key.path)}}if(t instanceof ai)return function(t,e){const n=t instanceof ai?t.toArray():t,r={fields:{[vn]:{stringValue:In},[Sn]:{arrayValue:{values:n.map((t=>{if("number"!=typeof t)throw e.createError("VectorValues must only contain numeric values.");return ar(e.serializer,t)}))}}}};return{mapValue:r}}(t,e);if(Ur(t))return t._toProto(e.serializer);throw e.createError(`Unsupported field value: ${ze(t)}`)}(t,e)}function gi(t,e){const n={};return function(t){for(const e in t)if(Object.prototype.hasOwnProperty.call(t,e))return!1;return!0}(t)?e.path&&e.path.length>0&&e.fieldMask.push(e.path):sn(t,((t,r)=>{const i=mi(r,e.childContextForField(t));null!=i&&(n[t]=i)})),{mapValue:{fields:n}}}function bi(t){return!("object"!=typeof t||null===t||t instanceof Array||t instanceof Date||t instanceof mn||t instanceof ui||t instanceof ii||t instanceof ti||t instanceof oi||t instanceof ai||Ur(t))}function yi(t,e,n){if(!bi(n)||!He(n)){const r=ze(n);throw"an object"===r?e.createError(t+" a custom object"):e.createError(t+" "+r)}}function vi(t,e,n){if((e=_(e))instanceof si)return e._internalPath;if("string"==typeof e)return function(t,e,n){if(e.search(Ei)>=0)throw Ni(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`,t,!1,void 0,n);try{return new si(...e.split("."))._internalPath}catch(r){throw Ni(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,t,!1,void 0,n)}}(t,e);throw Ni("Field path arguments must be of type string or ",t,!1,void 0,n)}const Ei=new RegExp("[~\\*/\\[\\]]");function Ni(t,e,n,r,i){const s=r&&!r.isEmpty(),o=void 0!==i;let u=`Function ${e}() called with invalid data`;n&&(u+=" (via `toFirestore()`)"),u+=". ";let a="";return(s||o)&&(a+=" (found",s&&(a+=` in field ${r}`),o&&(a+=` in document ${i}`),a+=")"),new we(pe.INVALID_ARGUMENT,u+t+a)}function Ii(t,e){return t.some((t=>t.isEqual(e)))}
/**
 * @license
 * Copyright 2020 Google LLC
 *

 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ii{constructor(t){this._byteString=t}static fromBase64String(t){try{return new ii(un.fromBase64String(t))}catch(t){throw new we(pe.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+t)}}static fromUint8Array(t){return new ii(un.fromUint8Array(t))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(t){return this._byteString.isEqual(t._byteString)}toJSON(){return{type:ii._jsonSchemaVersion,bytes:this.toBase64()}}static fromJSON(t){if(dn(t,ii._jsonSchema))return ii.fromBase64String(t.bytes)}}ii._jsonSchemaVersion="firestore/bytes/1.0",ii._jsonSchema={type:fn("string",ii._jsonSchemaVersion),bytes:fn("string")};
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class si{constructor(...t){for(let e=0;e<t.length;++e)if(0===t[e].length)throw new we(pe.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new Ve(t)}isEqual(t){return this._internalPath.isEqual(t._internalPath)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ui{constructor(t,e){if(!isFinite(t)||t<-90||t>90)throw new we(pe.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+t);if(!isFinite(e)||e<-180||e>180)throw new we(pe.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+e);this._lat=t,this._long=e}get latitude(){return this._lat}get longitude(){return this._long}isEqual(t){return this._lat===t._lat&&this._long===t._long}_compareTo(t){return $e(this._lat,t._lat)||$e(this._long,t._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:ui._jsonSchemaVersion}}static fromJSON(t){if(dn(t,ui._jsonSchema))return new ui(t.latitude,t.longitude)}}ui._jsonSchemaVersion="firestore/geoPoint/1.0",ui._jsonSchema={type:fn("string",ui._jsonSchemaVersion),latitude:fn("number"),longitude:fn("number")};
/**
 * @license
 ...
 * limitations under the License.
 */
class ai{constructor(t){this._values=(t||[]).map((t=>t))}toArray(){return this._values.map((t=>t))}isEqual(t){
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
return function(t,e){if(t.length!==e.length)return!1;for(let n=0;n<t.length;++n)if(t[n]!==e[n])return!1;return!0}(this._values,t._values)}toJSON(){return{type:ai._jsonSchemaVersion,vectorValues:this._values}}static fromJSON(t){if(dn(t,ai._jsonSchema)){if(Array.isArray(t.vectorValues)&&t.vectorValues.every((t=>"number"==typeof t)))return new ai(t.vectorValues);throw new we(pe.INVALID_ARGUMENT,"Expected 'vectorValues' field to be a number array")}}}ai._jsonSchemaVersion="firestore/vectorValue/1.0",ai._jsonSchema={type:fn("string",ai._jsonSchemaVersion),vectorValues:fn("object")};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
const ci=/^__.*__$/;class hi{constructor(t,e,n){this.data=t,this.fieldMask=e,this.fieldTransforms=n}toMutation(t,e){return null!==this.fieldMask?new gr(t,this.data,this.fieldMask,e,this.fieldTransforms):new mr(t,this.data,e,this.fieldTransforms)}}class li{constructor(t,e,n){this.data=t,this.fieldMask=e,this.fieldTransforms=n}toMutation(t,e){return new gr(t,this.data,this.fieldMask,e,this.fieldTransforms)}}function fi(t){switch(t){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw he(40011,{dataSource:t})}}class di{constructor(t,e,n,r,i,s){this.settings=t,this.databaseId=e,this.serializer=n,this.ignoreUndefinedProperties=r,void 0===i&&this.validatePath(),this.fieldTransforms=i||[],this.fieldMask=s||[]}get path(){return this.settings.path}get dataSource(){return this.settings.dataSource}contextWith(t){return new di({...this.settings,...t},this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}childContextForField(t){const e=this.path?.child(t),n=this.contextWith({path:e,arrayElement:!1});return n.validatePathSegment(t),n}childContextForFieldPath(t){const e=this.path?.child(t),n=this.contextWith({path:e,arrayElement:!1});return n.validatePath(),n}childContextForArray(t){return this.contextWith({path:void 0,arrayElement:!0})}createError(t){return Si(t,this.settings.methodName,this.settings.hasConverter||!1,this.path,this.settings.targetDoc)}contains(t){return void 0!==this.fieldMask.find((e=>t.isPrefixOf(e)))||void 0!==this.fieldTransforms.find((e=>t.isPrefixOf(e.field)))}validatePath(){if(this.path)for(let t=0;t<this.path.length;t++)this.validatePathSegment(this.path.get(t))}validatePathSegment(t){if(0===t.length)throw this.createError("Document fields must not be empty");if(fi(this.dataSource)&&ci.test(t))throw this.createError('Document fields cannot begin and end with "__"')}}class pi{constructor(t,e,n){this.databaseId=t,this.ignoreUndefinedProperties=e,this.serializer=n||jr(t)}createContext(t,e,n,r=!1){return new di({dataSource:t,methodName:e,targetDoc:n,path:Ve.emptyPath(),arrayElement:!1,hasConverter:r},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function wi(t){const e=t._freezeSettings(),n=jr(t._databaseId);return new pi(t._databaseId,!!e.ignoreUndefinedProperties,n)}class mi extends oi{_toFieldTransform(t){if(2!==t.dataSource)throw 1===t.dataSource?t.createError(`${this._methodName}() can only appear at the top level of your update data`):t.createError(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return t.fieldMask.push(t.path),null}isEqual(t){return t instanceof mi}}function gi(t,e){if(yi(t=_(t)))return vi("Unsupported field value:",e,t),bi(t,e);if(t instanceof oi)return function(t,e){if(!fi(e.dataSource))throw e.createError(`${t._methodName}() can only be used with update() and set()`);if(!e.path)throw e.createError(`${t._methodName}() is not currently supported inside arrays`);const n=t._toFieldTransform(e);n&&e.fieldTransforms.push(n)}(t,e),null;if(void 0===t&&e.ignoreUndefinedProperties)return null;if(e.path&&e.fieldMask.push(e.path),t instanceof Array){if(e.settings.arrayElement&&4!==e.dataSource)throw e.createError("Nested arrays are not supported");return function(t,e){const n=[];let r=0;for(const i of t){let t=gi(i,e.childContextForArray(r));null==t&&(t={nullValue:"NULL_VALUE"}),n.push(t),r++}return{arrayValue:{values:n}}}(t,e)}return function(t,e){if(null===(t=_(t)))return{nullValue:"NULL_VALUE"};if("number"==typeof t)return function(t,e){return function(t){return"number"==typeof t&&Number.isInteger(t)&&!We(t)&&t<=Number.MAX_SAFE_INTEGER&&t>=Number.MIN_SAFE_INTEGER}(e)?function(t){return{integerValue:""+t}}(e):ar(t,e)}(e.serializer,t);if("boolean"==typeof t)return{booleanValue:t};if("string"==typeof t)return{stringValue:t};if(t instanceof Date){const n=mn.fromDate(t);return{timestampValue:Sr(e.serializer,n)}}if(t instanceof mn){const n=new mn(t.seconds,1e3*Math.floor(t.nanoseconds/1e3));return{timestampValue:Sr(e.serializer,n)}}if(t instanceof ui)return{geoPointValue:{latitude:t.latitude,longitude:t.longitude}};if(t instanceof ii)return{bytesValue:Dr(e.serializer,t._byteString)};if(t instanceof ti){const n=e.databaseId,r=t.firestore._databaseId;if(!r.isEqual(n))throw e.createError(`Document reference is for database ${r.projectId}/${r.database} but should be for database ${n.projectId}/${n.database}`);return{referenceValue:_r(t.firestore._databaseId||e.databaseId,t._key.path)}}if(t instanceof ai)return function(t,e){const n=t instanceof ai?t.toArray():t,r={fields:{[vn]:{stringValue:In},[Sn]:{arrayValue:{values:n.map((t=>{if("number"!=typeof t)throw e.createError("VectorValues must only contain numeric values.");return ar(e.serializer,t)}))}}}};return{mapValue:r}}(t,e);if(Ur(t))return t._toProto(e.serializer);throw e.createError(`Unsupported field value: ${ze(t)}`)}(t,e)}function bi(t,e){const n={};return function(t){for(const e in t)if(Object.prototype.hasOwnProperty.call(t,e))return!1;return!0}(t)?e.path&&e.path.length>0&&e.fieldMask.push(e.path):sn(t,((t,r)=>{const i=gi(r,e.childContextForField(t));null!=i&&(n[t]=i)})),{mapValue:{fields:n}}}function yi(t){return!("object"!=typeof t||null===t||t instanceof Array||t instanceof Date||t instanceof mn||t instanceof ui||t instanceof ii||t instanceof ti||t instanceof oi||t instanceof ai||Ur(t))}function vi(t,e,n){if(!yi(n)||!He(n)){const r=ze(n);throw"an object"===r?e.createError(t+" a custom object"):e.createError(t+" "+r)}}function Ei(t,e,n){if((e=_(e))instanceof si)return e._internalPath;if("string"==typeof e)return Ii(t,e);throw Si("Field path arguments must be of type string or ",t,!1,void 0,n)}const Ni=new RegExp("[~\\*/\\[\\]]");function Ii(t,e,n){if(e.search(Ni)>=0)throw Si(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`,t,!1,void 0,n);try{return new si(...e.split("."))._internalPath}catch(r){throw Si(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,t,!1,void 0,n)}}function Si(t,e,n,r,i){const s=r&&!r.isEmpty(),o=void 0!==i;let u=`Function ${e}() called with invalid data`;n&&(u+=" (via `toFirestore()`)"),u+=". ";let a="";return(s||o)&&(a+=" (found",s&&(a+=` in field ${r}`),o&&(a+=` in document ${i}`),a+=")"),new we(pe.INVALID_ARGUMENT,u+t+a)}function Di(t,e){return t.some((t=>t.isEqual(e)))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ci extends $i{constructor(t){super(),this.firestore=t}convertBytes(t){return new ii(t)}convertReference(t){const e=this.convertDocumentKey(t,this.firestore._databaseId);return new ti(this.firestore,null,e)}}function Oi(t){!function(t){if("L"===t.limitType&&0===t.explicitOrderBy.length)throw new we(pe.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}((t=Je(t,Yr))._query);const e=Gr(t.firestore),n=new Ci(t.firestore);return zr(e,t._query).then((e=>{const r=e.map((e=>new Ti(t.firestore,n,e.key,e,t.converter)));return"L"===t._query.limitType&&r.reverse(),new _i(t,r)}))}function xi(t,e,n,...r){const i=wi((t=Je(t,ti)).firestore);let s;return s="string"==typeof(e=_(e))||e instanceof si?function(t,e,n,r,i,s){const o=t.createContext(1,e,n),u=[Ei(e,r,n)],a=[i];if(s.length%2!=0)throw new we(pe.INVALID_ARGUMENT,`Function ${e}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let t=0;t<s.length;t+=2)u.push(Ei(e,s[t])),a.push(s[t+1]);const c=[],h=nr.empty();for(let t=u.length-1;t>=0;--t)if(!Di(c,u[t])){const e=u[t];let n=a[t];n=_(n);const r=o.childContextForFieldPath(e);if(n instanceof mi)c.push(e);else{const t=gi(n,r);null!=t&&(c.push(e),h.set(e,t))}}const l=new er(c);return new li(h,l,o.fieldTransforms)}(i,"updateDoc",t._key,e,n,r):function(t,e,n,r){const i=t.createContext(1,e,n);vi("Data must be an object, but it was:",i,r);const s=[],o=nr.empty();sn(r,((t,r)=>{const u=Ii(e,t,n);r=_(r);const a=i.childContextForFieldPath(u);if(r instanceof mi)s.push(u);else{const t=gi(r,a);null!=t&&(s.push(u),o.set(u,t))}}));const u=new er(s);return new li(o,u,i.fieldTransforms)}(i,"updateDoc",t._key,e),Hr(Gr(t.firestore),[s.toMutation(t._key,pr.exists(!0))])}function Mi(t){return Hr(Gr((t=Je(t,ti)).firestore),[new br(t._key,pr.none())])}function Fi(t,e){const n=ri(t=Je(t,ei)),r=function(t,e){let n;return n=t?t.toFirestore(e):e,n}(t.converter,e),i=function(t,e,n,r,i,s={}){const o=t.createContext(s.merge||s.mergeFields?2:0,e,n,i);vi("Data must be an object, but it was:",o,r);const u=bi(r,o);let a,c;if(s.merge)a=new er(o.fieldMask),c=o.fieldTransforms;else if(s.mergeFields){const t=[];for(const r of s.mergeFields){const i=Ei(e,r,n);if(!o.contains(i))throw new we(pe.INVALID_ARGUMENT,`Field '${i}' is specified in your field mask but missing from your input data.`);Di(t,i)||t.push(i)}a=new er(t),c=o.fieldTransforms.filter((t=>a.covers(t.field)))}else a=null,c=o.fieldTransforms;return new hi(new nr(u),a,c)}(wi(t.firestore),"addDoc",n._key,r,null!==n.converter,{});return Hr(Gr(t.firestore),[i.toMutation(n._key,pr.exists(!1))]).then((()=>n))}const Ri="4.11.0";ie="12.9.0_lite",Lt(new $("firestore/lite",((t,{instanceIdentifier:e,options:n})=>{const r=t.getProvider("app").getImmediate(),i=new Xr(new ye(t.getProvider("auth-internal")),new Ie(r,t.getProvider("app-check-internal")),function(t,e){if(!Object.prototype.hasOwnProperty.apply(t.options,["projectId"]))throw new we(pe.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Ae(t.options.projectId,e)}(r,e),r);return n&&i._setSettings(n),i}),"PUBLIC").setMultipleInstances(!0)),Bt("firestore-lite",Ri,""),Bt("firestore-lite",Ri,"esm2020");const Pi=function(t){const e="object"==typeof t?t:function(t=xt){const e=Ft.get(t);if(!e&&t===xt&&g())return jt();if(!e)throw Vt.create("no-app",{appName:t});return e}(),n="string"==typeof t?t:"(default)",r=function(t,e){const n=t.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),t.container.getProvider(e)}(e,"firestore/lite").getImmediate({identifier:n});if(!r._initialized){const t=m("firestore");t&&function(t,e,n,r={}){t=Je(t,Xr);const i=y(e),s=t._getSettings(),o={...s,emulatorOptions:t._getEmulatorOptions()},u=`${e}:${n}`;i&&(async function(t){(await fetch(t,{credentials:"include"})).ok}
/**
 * @license
 * Copyright 2021 Google LLC
 *

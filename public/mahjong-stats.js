import{i as t,t as e,h as s,k as a}from"./custom-element-6f1a92a3.js";import{n as i,e as o}from"./select-option-ec247a15.js";import{o as r}from"./map-7f5238f0.js";import{g as n,c as d,d as l}from"./firestore-4afe899e.js";var h=function(t,e,s,a){for(var i,o=arguments.length,r=o<3?e:null===a?a=Object.getOwnPropertyDescriptor(e,s):a,n=t.length-1;n>=0;n--)(i=t[n])&&(r=(o<3?i(r):o>3?i(e,s,r):i(e,s))||r);return o>3&&r&&Object.defineProperty(e,s,r),r};let c=class extends s{render(){return a`
      <h1>総合成績</h1>
      <md-outlined-select
        required
        id="gameType"
      ...
      >
        ...
        ${r(this.distinctYears,(t=>{if(t!==(new Date).getFullYear())return a`<md-select-option value="${t}"
            >${t}</md-select-option
          >`}))}
      </md-outlined-select>
      <h2>総合ポイント</h2>

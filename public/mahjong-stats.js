...
import {g as d, c as n, d as l} from './firestore-724ae668.js';
var h = function (t, e, s, a) {
  for (
    ...
    (i = t[d]) && (o = (r < 3 ? i(o) : r > 3 ? i(e, s, o) : i(e, s)) || o);
...
let c = class extends i {
      ...
      >
        ...
        ${o(this.distinctYears, (t) => {
          if (t !== new Date().getFullYear())
            return r`<md-select-option value="${t}"
            >${t}</md-select-option
          >`;
        })}
      </md-outlined-select>
  ...
  async _loadData() {
    const t = (await d(n(l, 'results'))).docs,
      e = [],
      s = this._gameType.value || '四麻',
      a = Number(this._targetYear.value) || new Date().getFullYear();
    t.forEach((t) => {
      if (
        t.data().gameInfo.gameType !== s ||
        new Date(t.data().gameInfo.date).getFullYear() !== a
      )
        return;
      const i = t.data().results;
      e.push(...i);
    }),
      this._setDistinctYears(t),
      this._setTotalPoint(e),
      this._setMaxPoint(e),
  ...
  _setTotalPoint(t) {
    ...
    t.forEach((t) => {
      ...
      if (e.has(s)) {
        const t = (10 * (e.get(s) || 0) + 10 * a) / 10;
        e.set(s, t);
      } else e.set(s, a);
    });
    const s = Array.from(e.entries()).sort((t, e) => e[1] - t[1]);
    this.totalPoints = s.map((t, e) => ({
      index: e + 1,
      player: t[0],
      point: t[1],
    }));
...
(c.styles = [
  ...
  h([e({type: Array})], c.prototype, 'distinctYears', void 0),
  h([e({type: Array})], c.prototype, 'totalPoints', void 0),
  h([e({type: Array})], c.prototype, 'maxPoints', void 0),
  h([e({type: Array})], c.prototype, 'avoidLast', void 0),
  h([s('#gameType')], c.prototype, '_gameType', void 0),
  h([s('#targetYear')], c.prototype, '_targetYear', void 0),
  (c = h([a('mahjong-stats')], c));

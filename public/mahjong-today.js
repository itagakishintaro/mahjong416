...
import {o as h} from './map-7f5238f0.js';
import './pf-accordion-cc199819.js';
import './filled-button-87178736.js';
import {g as d, c as r, d as l} from './firestore-724ae668.js';
var n = function (t, e, s, i) {
  for (
    ...
    (a = t[d]) && (h = (o < 3 ? a(h) : o > 3 ? a(e, s, h) : a(e, s)) || h);
  return o > 3 && h && Object.defineProperty(e, s, h), h;
};
let c = class extends s {
  ...
  async _loadData() {
    (this.todaysResults = new Map()),
      (this.todaysChonbo = []),
      (this.todaysYakuman = []);
    const t = (await d(r(l, 'results'))).docs;
    ...
    t.forEach((t) => {
      ...
      const h = t.data().chonbo?.sort((t, e) => (t.player < e.player ? -1 : 1));
      h?.length > 0 && this.todaysChonbo.push(h);
      const d = t
        .data()
        .yakuman?.sort((t, e) => (t.player < e.player ? -1 : 1));
      d?.length > 0 && this.todaysYakuman.push(d),
...
(c.styles = [
  ...
  n([a({type: Array})], c.prototype, 'todaysYakuman', void 0),

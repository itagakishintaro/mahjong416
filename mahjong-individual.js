...
let MahjongIndividual = class MahjongIndividual extends LitElement {
    ...
    const chartData = docs
      ...
      .map((doc) => {
        return {
          ...
          point: doc
            .data()
            .results.find((result) => result.player === this._player.value)
            .point,
  ...
  _setPlayerData(allResults, allChonbo, allYakuman) {
...
__decorate([query('#player')], MahjongIndividual.prototype, '_player', void 0);
__decorate(
  [query('#myChart')],
  MahjongIndividual.prototype,
  '_myChart',
